...
public class MemberController {
    ...
    @GetMapping("/update")
    public String update(MemberVO_JPA vo, Model model) {
    ...
    public String selectAll(
        ...
        List<MemberVO_JPA> vos = service.selectAll(cpage, limit);
    ...
    public String searchList(
        ...
        List<MemberVO_JPA> vos = service.searchList(cpage, limit, searchKey, searchWord);
        model.addAttribute("vos", vos);
