...
public class BoardController {
    ...
    @GetMapping("/update")
    public String update(BoardVO_JPA vo, Model model) {
        log.info("/board/update");
        log.info("vo : {}",vo);

        BoardVO_JPA vo2 = service.selectOne(vo);
        log.info("vo2 : {}",vo2);
    ...
    public String selectOne(BoardVO_JPA vo, Model model) {
    ...
    public String selectAll(
        ...
        List<BoardVO_JPA> vos = service.selectAll(cpage,limit);
    ...
    public String searchList(
        ...
        List<BoardVO_JPA> vos = service.searchList(cpage,limit,searchKey,searchWord);
        log.info("vos.size() : {}",vos.size());
    ...
    public String insertOK(BoardVO_JPA vo) {
    ...
    public String updateOK(BoardVO_JPA vo) {
    ...
    @GetMapping("/deleteOK")
    public String deleteOK(BoardVO_JPA vo) {
